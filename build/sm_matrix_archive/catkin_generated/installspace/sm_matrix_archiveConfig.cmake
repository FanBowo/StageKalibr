...
if(NOT "include;/home/fanzhuzhi/kalibr_workspace/src/Kalibr/Schweizer-Messer/sm_common/include " STREQUAL " ")
  set(sm_matrix_archive_INCLUDE_DIRS "")
  set(_include_dirs "include;/home/fanzhuzhi/kalibr_workspace/src/Kalibr/Schweizer-Messer/sm_common/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sm_matrix_archive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fanzhuzhi/kalibr_workspace/install/${idir}'.  ${_report}")
    endif()
